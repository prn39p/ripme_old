...
public class TorClient {
     ...
     *
     * @param controlPort
     *            Port to connect to torUtils control server
     */
     ...
     *
     * @param controlPort
     *            controlPort Port to connect to torUtils control server
     * @param password
    ...
    /**
     * Creates a tcp connection to the local torUtils control server.
     *
    ...
    /**
     * Closes the tcp connection between this object and the torUtils control server.
     *
    ...
    /**
     * Sends a line to torUtils control server and receives the answer.
     *
     * @param msg
     * @return
     */
