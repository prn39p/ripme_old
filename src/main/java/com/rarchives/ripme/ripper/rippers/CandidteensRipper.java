...
public class CandidteensRipper extends AbstractHTMLRipper {

    private static final String DOMAIN = "candidteens.top", HOST = "candidteens";

    public CandidteensRipper(URL url) throws IOException {
        super(url);
    }
    ...
    public String getGID(URL url) throws MalformedURLException {
        ...
        try {
            ...
            title = title.replace(" – Candid Teens", "");
            return title;
        } catch (Exception e) {
            e.printStackTrace();
            return "missed";
    ...
    public List<String> getURLsFromPage(Document doc) {
        ...
        for (Element el : doc.select("a.snax-item-media-link > img")) {
